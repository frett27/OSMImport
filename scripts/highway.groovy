...
highway_pt=stream(osmstream, label: 'highway_pt') { 
        ...
        transform {  e-> on(e).keep(["width","sac_scale","access","surface","name","direction","cycleway","ref","lit","oneway","destination","motorroad","lanes","step_count","reference","abutters","area","sidewalk","operator","service","tracktype","footway","highway"]).newValue('osmid', e.id).end()  } 
 }
